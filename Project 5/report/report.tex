...
To ensure better accuracy a center derivative in time can be used as well. By letting $a=t+\Delta t/2$ and subtracting $a=t-\Delta t/2$ for the series (??) we can the following center time-derivative:
\begin{equation}
