...
The key to our stability analysis is to investegate how the numerical solution grows(or in the case of diffusion; decays) compared to the analytical. This will be done by using the known analytical solution on the form:
\begin{equation}
...
\end{align*} 
wich is satisfied for $\frac{\Delta t}{\Delta x^2} \leq \frac{1}{2}$.
