...
\textcolor{red}{MU: Reducing matrix}

The backsubstitution is simple when a row reduced matrix is achieved.

Let us look at the matrix equation $Ux = y$
\begin{gather}
...
The solvers implementation is unknown for us, and we will assume
it follows $\bigO{N^3}$. Calling of this function is
\begin{gather}
x = solve(A, \tilde{f})
\end{gather}
