...
each have an energy connected to the spin. The net amount of spin in the 
lattice leads to an overall magnetisation. The energy in the lattice 
is connected to a heat reservoir which causes the spins to be 
randomly oriented.
...
\label{fig:spin_neighbours_simple}
\end{figure}
